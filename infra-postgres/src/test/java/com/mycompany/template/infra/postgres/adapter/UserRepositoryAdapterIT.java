...
import com.mycompany.template.infra.postgres.mapper.UserPostgresMapperImpl;
...
@Import({UserRepositoryAdapterIT.ContainersConfig.class, UserRepositoryAdapter.class, UserPostgresMapperImpl.class})
@Tag("integration")
