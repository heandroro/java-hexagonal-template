...
class UserGrpcServiceTest {
    ...
    void createUser_shouldReturnProtoResponse_whenRequestIsValid() {
        ...
        given(createUserUseCase.execute(new CreateUserCommand("John", "john@example.com"))).willReturn(user);

        service.createUser(request, observer);

        then(observer).should().onNext(UserProtoConverter.toProtoResponse(user));
    ...
    void listUsers_shouldReturnProtoListResponse_whenUsersExist() {
        ...
        then(observer).should().onNext(UserProtoConverter.toProtoListResponse(page));
        then(observer).should().onCompleted();
    }
    ...
    void updateUser_shouldReturnProtoResponse_whenRequestIsValid() {
        ...
        given(updateUserUseCase.execute(id, new UpdateUserCommand("Jane", "jane@example.com"))).willReturn(user);
    ...
    void patchUser_shouldReturnProtoResponse_whenRequestIsValid() {
        ...
        given(patchUserUseCase.execute(id, new PatchUserCommand("Patched", null))).willReturn(user);
