...
class UserRepositoryAdapterTest {
    ...
    @Mock
    private UserMariadbMapper userMariadbMapper;
    ...
    class Save {
        ...
        void should_persistAndReturnMappedDomain() {
            ...
            given(userMariadbMapper.toEntity(user)).willReturn(entity);
            given(userJpaRepository.save(entity)).willReturn(entity);
            given(userMariadbMapper.toDomain(entity)).willReturn(user);
